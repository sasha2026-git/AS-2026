...
<div id="page-the-atelier">
        ...
        <div id="atelier-grid">
            <div class="shop-item" data-category="personal" style="text-align:center">
                <div class="aura-glass" style="aspect-ratio:1;border-radius:12px;margin-bottom:8px;overflow:hidden;display:flex;align-items:center;justify-content:center">
                    <img src="https://images.unsplash.com/photo-1588405748880-12d1d2a59f75?w=400&q=80" alt="Aura No.1" style="width:66%;height:66%;object-fit:contain;transition:transform .5s" loading="lazy">
                </div>
                <h4 class="font-headline-md" style="font-size:15px;margin-bottom:2px;font-style:italic">Aura No. 1</h4>
                <p class="font-label-caps text-label-caps" style="color:var(--secondary);font-size:11px;margin-bottom:4px">Personal · Ozone</p>
                <span class="font-body-md" style="color:var(--on-surface);font-size:13px">$185.00</span>
            </div>
            <div class="shop-item" data-category="personal" style="text-align:center">
                <div class="aura-glass" style="aspect-ratio:1;border-radius:12px;margin-bottom:8px;overflow:hidden;display:flex;align-items:center;justify-content:center">
                    <img src="https://images.unsplash.com/photo-1541643600914-78b084683601?w=400&q=80" alt="Aura No.2" style="width:66%;height:66%;object-fit:contain;transition:transform .5s" loading="lazy">
                </div>
                <h4 class="font-headline-md" style="font-size:15px;margin-bottom:2px;font-style:italic">Aura No. 2</h4>
                <p class="font-label-caps text-label-caps" style="color:var(--secondary);font-size:11px;margin-bottom:4px">Personal · Oud</p>
            ...
            <div class="shop-item" data-category="home" style="text-align:center">
                <div class="aura-glass" style="aspect-ratio:1;border-radius:12px;margin-bottom:8px;overflow:hidden;display:flex;align-items:center;justify-content:center">
                    <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&q=80" alt="Atmospheric Flux" style="width:66%;height:66%;object-fit:contain;transition:transform .5s" loading="lazy">
                </div>
                <h4 class="font-headline-md" style="font-size:15px;margin-bottom:2px;font-style:italic">Atmospheric Flux</h4>
                <p class="font-label-caps text-label-caps" style="color:var(--secondary);font-size:11px;margin-bottom:4px">Home · Adaptive</p>
            ...
            <div class="shop-item" data-category="commercial" style="text-align:center">
                <div class="aura-glass" style="aspect-ratio:1;border-radius:12px;margin-bottom:8px;overflow:hidden;display:flex;align-items:center;justify-content:center">
                    <img src="https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=400&q=80" alt="Spatial Bloom" style="width:66%;height:66%;object-fit:contain;transition:transform .5s" loading="lazy">
                </div>
                <h4 class="font-headline-md" style="font-size:15px;margin-bottom:2px;font-style:italic">Spatial Bloom</h4>
                <p class="font-label-caps text-label-caps" style="color:var(--secondary);font-size:11px;margin-bottom:4px">Commercial · Ambient</p>
                <span class="font-body-md" style="color:var(--on-surface);font-size:13px">$320.00</span>
            </div>
            <div class="shop-item" data-category="personal" style="text-align:center">
                <div class="aura-glass" style="aspect-ratio:1;border-radius:12px;margin-bottom:8px;overflow:hidden;display:flex;align-items:center;justify-content:center">
                    <img src="https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?w=400&q=80" alt="Vesper Muse" style="width:66%;height:66%;object-fit:contain;transition:transform .5s" loading="lazy">
                </div>
                <h4 class="font-headline-md" style="font-size:15px;margin-bottom:2px;font-style:italic">Vesper Muse</h4>
                <p class="font-label-caps text-label-caps" style="color:var(--secondary);font-size:11px;margin-bottom:4px">Personal · Floral</p>
                <span class="font-body-md" style="color:var(--on-surface);font-size:13px">$185.00</span>
            </div>
            <div class="shop-item" data-category="commercial" style="text-align:center">
                <div class="aura-glass" style="aspect-ratio:1;border-radius:12px;margin-bottom:8px;overflow:hidden;display:flex;align-items:center;justify-content:center">
                    <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&q=80" alt="Nordic Noir" style="width:66%;height:66%;object-fit:contain;transition:transform .5s" loading="lazy">
                </div>
                <h4 class="font-headline-md" style="font-size:15px;margin-bottom:2px;font-style:italic">Nordic Noir</h4>
                <p class="font-label-caps text-label-caps" style="color:var(--secondary);font-size:11px;margin-bottom:4px">Commercial · Forest</p>
    ...
    <section class="px-margin-desktop container-max" style="padding-bottom:36px">
        <div class="bg-on-surface" style="border-radius:24px;padding:24px;text-align:center;color:var(--surface)">
            ...
            <a class="iridescent-btn font-label-caps text-label-caps" style="padding:10px 24px;border-radius:999px;font-size:12px" href="<?php echo esc_url(home_url('/ai-synthesis/')); ?>">Request Consultation</a>
        </div>
    </section>
</div>
