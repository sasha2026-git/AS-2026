...
<div id="page-archive">
    ...
    <section class="px-margin-desktop container-max" style="padding-bottom:36px">
        ...
        <div id="archive-personal" style="margin-bottom:24px">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px">
                <span class="font-label-caps text-label-caps text-secondary" style="font-size:12px">FOR PERSONAL</span>
        ...
        <div id="archive-home" style="margin-bottom:24px">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px">
                <span class="font-label-caps text-label-caps text-secondary" style="font-size:12px">FOR HOME</span>
                <div style="flex:1;height:1px;background:color-mix(in srgb,var(--outline-variant)30%,transparent)"></div>
            </div>
            <div class="archive-items-grid">
                <div class="aura-glass archive-item" style="border-radius:12px;padding:14px;display:flex;gap:12px" data-category="home">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="display:flex;gap:4px;flex-wrap:wrap;margin-bottom:4px">
                            <span class="font-label-caps" style="font-size:11px;padding:2px 6px;border-radius:4px;background:var(--surface-container-high);color:var(--on-surface-variant)">ADAPTIVE</span>
                            <span class="font-label-caps" style="font-size:11px;padding:2px 6px;border-radius:4px;background:var(--surface-container-high);color:var(--on-surface-variant)">SPACE</span>
                        </div>
        ...
        <div id="archive-commercial" style="margin-bottom:24px">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px">
                <span class="font-label-caps text-label-caps text-secondary" style="font-size:12px">FOR COMMERCIAL</span>
                <div style="flex:1;height:1px;background:color-mix(in srgb,var(--outline-variant)30%,transparent)"></div>
            </div>
            <div class="archive-items-grid">
                <div class="aura-glass archive-item" style="border-radius:12px;padding:14px;display:flex;gap:12px" data-category="commercial">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="display:flex;gap:4px;flex-wrap:wrap;margin-bottom:4px">
                            <span class="font-label-caps" style="font-size:11px;padding:2px 6px;border-radius:4px;background:var(--surface-container-high);color:var(--on-surface-variant)">LUXURY</span>
                            <span class="font-label-caps" style="font-size:11px;padding:2px 6px;border-radius:4px;background:var(--surface-container-high);color:var(--on-surface-variant)">RETAIL</span>
                        </div>
                        <span class="font-label-caps" style="font-size:11px;padding:2px 8px;border-radius:4px;background:color-mix(in srgb,var(--secondary-container)30%,transparent);color:var(--secondary)">CUSTOM</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="px-margin-desktop container-max" style="padding-bottom:36px">
        <div class="bg-on-surface" style="border-radius:24px;padding:24px;text-align:center;color:var(--surface)">
            ...
            <a class="iridescent-btn font-label-caps text-label-caps" style="padding:10px 24px;border-radius:999px;font-size:12px" href="<?php echo esc_url(home_url('/ai-synthesis/')); ?>">Begin Your Brief</a>
        </div>
    </section>
</div>
<!-- ===== THE ATELIER ===== -->
