...
if (function_exists('acf_add_local_field_group')) {
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_h_arc1_link',
                'label' => '卡片 1 链接(URL)',
                'name' => 'allscented_home_arc1_link',
                'type' => 'url',
                'default_value' => '',
                'placeholder' => 'https:// 或 /journal/xxx 文章链接',
                'instructions' => '点击卡片跳转的文章链接；留空则跳到 Journal 列表页',
                'wrapper' => array('width' => 50),
            ),
            array(
            ...
            array(
                'key' => 'field_h_arc2_link',
                'label' => '卡片 2 链接(URL)',
                'name' => 'allscented_home_arc2_link',
                'type' => 'url',
                'default_value' => '',
                'placeholder' => 'https:// 或 /journal/xxx 文章链接',
                'instructions' => '点击卡片跳转的文章链接；留空则跳到 Journal 列表页',
            ...
            array(
                'key' => 'field_h_arc3_link',
                'label' => '卡片 3 链接(URL)',
                'name' => 'allscented_home_arc3_link',
                'type' => 'url',
                'default_value' => '',
                'placeholder' => 'https:// 或 /journal/xxx 文章链接',
                'instructions' => '点击卡片跳转的文章链接；留空则跳到 Journal 列表页',
            ...
            array(
                'key' => 'field_h_col_main_link',
                'label' => '左侧大图链接(URL)',
                'name' => 'allscented_home_col_main_link',
                'type' => 'url',
                'default_value' => '',
                'placeholder' => 'https:// 或 /the-atelier/',
                'instructions' => '点击大图跳转的链接；留空则跳到 THE ATELIER 页',
                'wrapper' => array('width' => 50),
            ),
            array(
            ...
            array(
                'key' => 'field_h_colp1_link',
                'label' => '产品 1 链接(URL)',
                'name' => 'allscented_home_colp1_link',
                'type' => 'url',
                'default_value' => '',
                'placeholder' => 'https:// 或 /product/xxx 产品链接',
                'instructions' => '点击产品卡片跳转的产品链接；留空则跳到 THE ATELIER 页',
                'wrapper' => array('width' => 50),
            ),
            array(
            ...
            array(
                'key' => 'field_h_colp2_link',
                'label' => '产品 2 链接(URL)',
                'name' => 'allscented_home_colp2_link',
                'type' => 'url',
                'default_value' => '',
                'placeholder' => 'https:// 或 /product/xxx 产品链接',
                'instructions' => '点击产品卡片跳转的产品链接；留空则跳到 THE ATELIER 页',
