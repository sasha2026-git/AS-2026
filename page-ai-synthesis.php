...
<div id="page-ai-synthesis">
    ...
    <section class="px-margin-desktop container-max" style="padding-bottom:36px">
        <div class="char-cards-grid">
            ...
            <div class="aura-glass char-card<?php echo $g1_avatar ? ' guide-hero-card' : ''; ?>" style="border-radius:16px;overflow:hidden;position:relative;display:flex;flex-direction:column;<?php echo $g1_avatar ? 'padding:0' : 'padding:20px'; ?>">
                <?php if ($g1_avatar): ?>
                ...
                <div class="guide-hero-body" style="position:relative;z-index:1;margin-top:auto;padding:22px 20px 20px;display:flex;flex-direction:column;flex:1;justify-content:flex-end">
                    ...
                    <span class="font-label-caps text-label-caps" style="font-size:12px;margin-bottom:2px;letter-spacing:.12em;color:<?php echo $g1_avatar ? 'rgba(233,193,118,.95)' : 'var(--secondary)'; ?>"><?php echo esc_html($g1_role); ?></span>
                    <h3 class="font-headline-md" style="font-size:20px;margin-bottom:2px;font-style:italic;<?php echo $g1_avatar ? 'color:#f7f1e7;' : ''; ?>"><?php echo esc_html($g1_name); ?></h3>
                    <span class="font-label-caps" style="font-size:14px;font-weight:500;color:<?php echo $g1_avatar ? "rgba(233,193,118,.9)" : "var(--secondary)"; ?>;letter-spacing:.04em">Luná</span>
                    <p class="font-body-md" style="font-size:14px;margin:6px 0 12px;color:<?php echo $g1_avatar ? 'rgba(255,255,255,.85)' : 'var(--on-surface-variant)'; ?>"><?php echo esc_html($g1_desc); ?></p>
                    <div>
                        <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px">
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g1_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--secondary-container)30%,transparent)"; ?>;color:<?php echo $g1_avatar ? "rgba(233,193,118,.95)" : "var(--secondary)"; ?>">EMOTIONAL</span>
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g1_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--secondary-container)30%,transparent)"; ?>;color:<?php echo $g1_avatar ? "rgba(233,193,118,.95)" : "var(--secondary)"; ?>">THERAPEUTIC</span>
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g1_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--secondary-container)30%,transparent)"; ?>;color:<?php echo $g1_avatar ? "rgba(233,193,118,.95)" : "var(--secondary)"; ?>">PERSONAL</span>
            ...
            <div class="aura-glass char-card<?php echo $g2_avatar ? ' guide-hero-card' : ''; ?>" style="border-radius:16px;overflow:hidden;position:relative;display:flex;flex-direction:column;<?php echo $g2_avatar ? 'padding:0' : 'padding:20px'; ?>">
                <?php if ($g2_avatar): ?>
                <div style="position:absolute;inset:0">
                ...
                <div class="guide-hero-body" style="position:relative;z-index:1;margin-top:auto;padding:22px 20px 20px;display:flex;flex-direction:column;flex:1;justify-content:flex-end">
                    ...
                    <span class="font-label-caps text-label-caps" style="font-size:12px;margin-bottom:2px;letter-spacing:.12em;color:<?php echo $g2_avatar ? 'rgba(233,193,118,.95)' : 'var(--secondary)'; ?>"><?php echo esc_html($g2_role); ?></span>
                    <h3 class="font-headline-md" style="font-size:20px;margin-bottom:2px;font-style:italic;<?php echo $g2_avatar ? 'color:#f7f1e7;' : ''; ?>"><?php echo esc_html($g2_name); ?></h3>
                    
                    <p class="font-body-md" style="font-size:14px;margin:6px 0 12px;color:<?php echo $g2_avatar ? 'rgba(255,255,255,.85)' : 'var(--on-surface-variant)'; ?>"><?php echo esc_html($g2_desc); ?></p>
                    <div>
                        <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px">
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g2_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--tertiary-container)40%,transparent)"; ?>;color:<?php echo $g2_avatar ? "rgba(233,193,118,.95)" : "var(--tertiary)"; ?>">DIVINATION</span>
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g2_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--tertiary-container)40%,transparent)"; ?>;color:<?php echo $g2_avatar ? "rgba(233,193,118,.95)" : "var(--tertiary)"; ?>">INCENSE</span>
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g2_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--tertiary-container)40%,transparent)"; ?>;color:<?php echo $g2_avatar ? "rgba(233,193,118,.95)" : "var(--tertiary)"; ?>">RITUAL</span>
            ...
            <div class="aura-glass char-card<?php echo $g3_avatar ? ' guide-hero-card' : ''; ?>" style="border-radius:16px;overflow:hidden;position:relative;display:flex;flex-direction:column;<?php echo $g3_avatar ? 'padding:0' : 'padding:20px'; ?>">
                <?php if ($g3_avatar): ?>
                <div style="position:absolute;inset:0">
                ...
                <div class="guide-hero-body" style="position:relative;z-index:1;margin-top:auto;padding:22px 20px 20px;display:flex;flex-direction:column;flex:1;justify-content:flex-end">
                    ...
                    <span class="font-label-caps text-label-caps" style="font-size:12px;margin-bottom:2px;letter-spacing:.12em;color:<?php echo $g3_avatar ? 'rgba(233,193,118,.95)' : 'var(--secondary)'; ?>"><?php echo esc_html($g3_role); ?></span>
                    <h3 class="font-headline-md" style="font-size:20px;margin-bottom:2px;font-style:italic;<?php echo $g3_avatar ? 'color:#f7f1e7;' : ''; ?>"><?php echo esc_html($g3_name); ?></h3>
                    
                    <p class="font-body-md" style="font-size:14px;margin:6px 0 12px;color:<?php echo $g3_avatar ? 'rgba(255,255,255,.85)' : 'var(--on-surface-variant)'; ?>"><?php echo esc_html($g3_desc); ?></p>
                    <div>
                        <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px">
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g3_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--primary-container)40%,transparent)"; ?>;color:<?php echo $g3_avatar ? "rgba(233,193,118,.95)" : "var(--primary)"; ?>">COMMERCIAL</span>
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g3_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--primary-container)40%,transparent)"; ?>;color:<?php echo $g3_avatar ? "rgba(233,193,118,.95)" : "var(--primary)"; ?>">BRANDING</span>
                        <span class="font-label-caps" style="font-size:11px;padding:3px 8px;border-radius:999px;background:<?php echo $g3_avatar ? "rgba(233,193,118,.14)" : "color-mix(in srgb,var(--primary-container)40%,transparent)"; ?>;color:<?php echo $g3_avatar ? "rgba(233,193,118,.95)" : "var(--primary)"; ?>">CONSULT</span>
